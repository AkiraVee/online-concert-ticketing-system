...
if (isset($_SESSION['UserID'])) {
 ...
 $insertQuery = "insert into ordertb (UserID, EventDate, SeatLocation, TicketQuantity, TotalPrice, TransactionPin, PurchaseDate, EventLocation, PaymentMethod)
            values ($userID, '$parsedDate', '$tier', '$quantity', '$grandTotal', '$transactionPin', NOW(), '$eventLocation', '$paymentMethod')";
