          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <input type="password" id="passwordInput" required
                class="w-full bg-zinc-950 border border-zinc-700 rounded-xl px-5 py-3 text-white focus:outline-none focus:border-violet-500 transition-colors"
                placeholder="••••••••" />
              <span id="passwordError" class="hidden text-red-500 text-xs mt-1 block"></span>
            </div>

            <div id="credentialError" class="hidden p-3 bg-red-950 border border-red-700 rounded-lg text-red-300 text-sm text-center">
  ...
  <script>
    ...
    document.getElementById("loginForm").addEventListener("submit", function (e) {
      ...
      if (match) {
        ...
        document.getElementById("credentialError").classList.remove("hidden");
      }
    });
  </script>
</body>
