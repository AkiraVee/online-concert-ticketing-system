...
<body class="bg-zinc-950 text-zinc-300">
  ...
  <script>
    const events = [
      ...
      { id: 2, title: "PBA: Ginebra vs TNT", category: "sports", date: "May 15, 2026", location: "Smart Araneta Coliseum", price: "₱500", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRel2BkhvraSCdtKrKVtE1undLe14McGM4AgQ&s", type: "Sports" },
      { id: 3, title: "Miss Saigon - Manila", category: "theatre", date: "June 10, 2026", location: "Newport Performing Arts Theater", price: "₱2,200", image: "https://theaterfansmanila.com/wp-content/uploads/2023/10/Miss-Saigon-feat-pic.jpg", type: "Theatre" },
      { id: 4, title: "Coldplay World Tour", category: "concert", date: "July 5, 2026", location: "MOA Arena, Pasay", price: "₱1,500", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuEJOC_Sm2eUoa629dYjjw-A7rfs4q0sx7ZA&s", type: "Concert" },
      { id: 5, title: "UAAP Men's Basketball: Ateneo vs La Salle", category: "sports", date: "May 25, 2026", location: "Smart Araneta Coliseum", price: "₱500", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQC9sHGXewX7wEEO0LOFJ-BBcUXAbiWpPNQ2A&s", type: "Sports" },
      { id: 6, title: "Music Festival 2026", category: "festival", date: "June 20, 2026", location: "Mall of Asia Grounds", price: "₱1,800", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFTcjSKXMIKWe_V00j-0_ii0FUTkUI9nPmqw&s", type: "Festival" },
      { id: 7, title: "Hamilton - Manila", category: "theatre", date: "August 15, 2026", location: "Newport Performing Arts Theater", price: "₱3,000", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMqFf1Wvg6byazp3YQ2qs-nlNDmNpBmZBm0Q&s", type: "Theatre" },
      { id: 8, title: "Daniel Caesar Live in Manila", category: "concert", date: "September 10, 2026", location: "Philippine Arena, Bulacan", price: "₱2,750", image: "https://aphrodite.gmanetwork.com/entertainment/articles/1200_675_11_07-04-2026-1513_-20260407151314.jpg", type: "Concert" },
      { id: 9, title: "My Chemical Romance Reunion Tour", category: "concert", date: "October 5, 2026", location: "MOA Arena, Pasay", price: "₱1,800", image: "https://static.easyrock.com.ph/posts/2025/7/D24MN_6tBshHyzklGDfPC.jpeg", type: "Concert" },
      ...
      { id: 11, title: "Epic: The Musical - Manila", category: "theatre", date: "December 10, 2026", location: "Newport Performing Arts Theater", price: "₱2,800", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLyeZHMjAKjedyosMPPtKMDEkhXOUGP-FKLQ&s", type: "Theatre" },
      ...
      { id: 13, title: "Hatsune Miku Expo 2026", category: "festival", date: "February 20, 2027", location: "Mall of Asia Grounds", price: "₱1,500", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBVRHWKBAate79pso9-qtG7KSGq5I2UprDsA&s", type: "Festival" },
      ...
      { id: 16, title: "The Greatest Showman Live Experience", category: "theatre", date: "May 20, 2027", location: "Newport Performing Arts Theater", price: "₱3,200", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqkgJb8uKCbWDDTQnM53jlsgiNOc-2gjbkew&s", type: "Theatre" }
    ];
