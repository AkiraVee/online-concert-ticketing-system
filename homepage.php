...
<body class="bg-zinc-950 text-zinc-300">
  ...
  <script>
    // ==================== FULL EVENTS DATA ====================
    const events = [
      { id: 1, title: "Taylor Swift | The Eras Tour", category: "concert", date: "May 20, 2026", location: "Philippine Arena, Bulacan", price: "₱3,500", image: "https://picsum.photos/id/1015/400/250", type: "Concert" },
      { id: 2, title: "PBA: Ginebra vs TNT", category: "sports", date: "May 15, 2026", location: "Smart Araneta Coliseum", price: "₱500", image: "https://picsum.photos/id/201/400/250", type: "Sports" },
      { id: 3, title: "Miss Saigon - Manila", category: "theatre", date: "June 10, 2026", location: "Newport Performing Arts Theater", price: "₱2,200", image: "https://picsum.photos/id/237/400/250", type: "Theatre" },
      { id: 4, title: "Coldplay World Tour", category: "concert", date: "July 5, 2026", location: "MOA Arena, Pasay", price: "₱1,500", image: "https://picsum.photos/id/870/400/250", type: "Concert" },
      { id: 5, title: "UAAP: Ateneo vs La Salle", category: "sports", date: "May 25, 2026", location: "Smart Araneta Coliseum", price: "₱500", image: "https://picsum.photos/id/180/400/250", type: "Sports" },
      { id: 6, title: "Music Festival 2026", category: "festival", date: "June 20, 2026", location: "Mall of Asia Grounds", price: "₱1,800", image: "https://picsum.photos/id/1016/400/250", type: "Festival" },
      { id: 7, title: "Hamilton - Manila", category: "theatre", date: "August 15, 2026", location: "Newport Performing Arts Theater", price: "₱3,000", image: "https://picsum.photos/id/1025/400/250", type: "Theatre" },
      { id: 8, title: "Daniel Caesar Live in Manila", category: "concert", date: "September 10, 2026", location: "Philippine Arena, Bulacan", price: "₱2,750", image: "https://picsum.photos/id/1027/400/250", type: "Concert" },
      { id: 9, title: "My Chemical Romance Reunion Tour", category: "concert", date: "October 5, 2026", location: "MOA Arena, Pasay", price: "₱1,800", image: "https://picsum.photos/id/1033/400/250", type: "Concert" },
      { id: 10, title: "Bruno Mars 24K Magic Tour", category: "concert", date: "November 20, 2026", location: "Philippine Arena, Bulacan", price: "₱2,500", image: "https://picsum.photos/id/1035/400/250", type: "Concert" },
      { id: 11, title: "Epic: The Musical - Manila", category: "theatre", date: "December 10, 2026", location: "Newport Performing Arts Theater", price: "₱2,800", image: "https://picsum.photos/id/1040/400/250", type: "Theatre" },
      { id: 12, title: "The 1975 Live in Manila", category: "concert", date: "January 15, 2027", location: "MOA Arena, Pasay", price: "₱1,975", image: "https://picsum.photos/id/1041/400/250", type: "Concert" },
      { id: 13, title: "Hatsune Miku Expo 2026", category: "festival", date: "February 20, 2027", location: "Mall of Asia Grounds", price: "₱1,500", image: "https://picsum.photos/id/1042/400/250", type: "Festival" },
      { id: 14, title: "Ado Live in Manila", category: "concert", date: "March 10, 2027", location: "Philippine Arena, Bulacan", price: "₱2,500", image: "https://picsum.photos/id/1043/400/250", type: "Concert" },
      { id: 15, title: "Laufey A Matter of Time Tour", category: "concert", date: "April 5, 2027", location: "MOA Arena, Pasay", price: "₱2,500", image: "https://picsum.photos/id/1044/400/250", type: "Concert" },
      { id: 16, title: "The Greatest Showman Live Experience", category: "theatre", date: "May 20, 2027", location: "Newport Performing Arts Theater", price: "₱3,200", image: "https://picsum.photos/id/1045/400/250", type: "Theatre" }
    ];
    ...
    function renderEvents(list) {
      ...
      grid.innerHTML = list.map(e => `
        <div class="card bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden cursor-pointer hover:scale-[1.02] transition-transform" onclick="viewEvent(${e.id})">
          ...
          <div class="p-4">
            ...
            <p class="text-zinc-500 text-xs mb-4 flex items-center gap-1">
              <i class="fa-solid fa-location-dot"></i> ${e.location}
            </p>
            <div class="flex items-center justify-between">
              <span class="text-violet-400 font-semibold">${e.price}</span>
              <button onclick="event.stopPropagation(); buyTicket(${e.id})" 
